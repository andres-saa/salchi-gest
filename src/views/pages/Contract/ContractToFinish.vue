    ...
    <div class="m-auto container ">
        ...
        <template #header>
            <div class="grid p-3" style="align-items:center;justify-content: space-between; display: flex;gap: 1rem;">
                <h4 class="px-2"> <i class="fa fa-book"></i>  <b>Contratos proximos a finalizar</b></h4>
...
onMounted(async() => {
    contrats.value = await fetchService.get(`${URI}/get-all-to-finish-contracts`,'cargando contratos')
})
