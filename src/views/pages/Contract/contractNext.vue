    ...
    <div class="m-auto container ">
        ...
        <template #header>
            <div class="grid p-3" style="align-items:center;justify-content: space-between; display: flex;gap: 1rem;">
                <h4 class="px-2"> <i class="fa fa-book"></i>  <b>Contratos proximos</b></h4>
        ...
        <column #body="contract" :header="column.columnName" v-for="column in dataColumns" :field="column.columnValue">
            ...
            <h6 style="min-width: 5rem;" v-if="column.columnType == 'other'" class="m-0 p-0">
                {{ contract.data[column.columnValue] }}
            </h6>
...
const dataColumns = [
    ...
    {
        columnName:'Dias para iniciar',
        columnValue:'days_until_start',
        columnType:'other'
    },
...
onMounted(async() => {
    contrats.value = await fetchService.get(`${URI}/get-all-future-contracts`,'cargando contratos','/contracts/contracts-all/')
})
