<template>
  <Dialog :close=" reset() "  :closable="false" v-model:visible="store.visibles.currentProduct" :style="{ width: '500px', }" 
    ...
    <div class="grid col-12 p-0  md:p-2 m-auto">
        ...
        <div style="color: black;">
          ...
          <div v-for="grupo in adicionales" :key="grupo.category">
            <div class="mb-2">
              ...
              <div class="mt-2">
                <div v-for="item in grupo.items" :key="item.aditional_item_instance_id" style="display: flex; gap: 1rem; align-items: center;">
...
import { showProductDialog, productDialog, checkedSalsas, checkedAdiciones, currentSalsas, currentAditions } from '@/service/state';
