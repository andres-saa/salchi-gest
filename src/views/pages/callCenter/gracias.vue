<template>
    <div class="p-2 col-12 my-3" style="height: auto;min-height: 90vh;background-color: white; display: flex; justify-content: center; align-items: center;">
        <div class="shadow-3 p-4" style="border-radius: 0.5rem; max-width: 500px;">
            <p class="text-2xl text-center mt-5" style="font-weight: bold;"> 🤩{{user.user.name.toUpperCase()}}🤩</p>
            <p class="text-2xl text-center mb-5" style="font-weight: bold;">🔥Bien! Este el numero de orden del cliente🔥</p>
            ...
            <p class="text-2xl text-center my-3 p-3" style=" border-radius: .3rem; background-color: var(--primary-color); color: white;">La sede ha recibido el pedido y en breve será despachado</p>
