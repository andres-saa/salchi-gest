<template>
    <div @click="open" class="col-12 " :style="store.currentSearchingOrder.order_id == props.order.order_id? 'border:3px solid var(--primary-color)' : ''" style="background-color: rgba(255, 255, 255, 0.506);border-radius: 0.5rem;cursor: pointer;">
