<template>
    <div v-if="store.visibleNotifications" class="card p-4 col-12 xl:col-4 mt-3 m-0 notificaciones"  :style="store.visibleNotifications? 'transform:scaleX(100%)':'transform:scaleX(100%);'" >
    <div class=""  >
