    ...
    <Dialog v-model:visible="dialogPedirTema" modal style="max-width: 94%;width: 40rem; border: none;">
        ...
        <template #footer>
            <div class="dialog-footer">
                ...
                <Button label="Solicitar"  severity="help" icon="pi pi-check" :disabled="!selectedAvailableSong"
    ...
    <Dialog v-model:visible="dialogSolicitarNombre" modal style="max-width: 94%;width: 30rem;">
        ...
        <template #footer>
            <div class="dialog-footer">
                ...
                <Button label="Solicitar" icon="pi pi-check" severity="help" :disabled="!requesterName.trim()"
