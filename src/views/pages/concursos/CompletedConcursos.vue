<template>
    ...
    <div style="position: fixed;left: -2rem; z-index: -1;filter: blur(10px);" class="col-12">
        <img style="width: 120%;left: 0rem;height: 100vh;object-fit: cover;"
            src="https://backend.salchimonster.com/read-product-image/600/site-8" alt="">
    </div>

    <div class="container mx-auto p-2" style="max-width:700px;z-index: 99; ">

        <p class="text-white text-4xl text-center" style="font-weight: bold;"> CONCURSOS FINALIZADOS</p>
        ...
        <div class="container_contests" style="display: flex;flex-direction: column;gap: 2rem;">
            ...
            <div class="container_contest_item p-2" v-for="contest in contests.filter(c => !c.vigent && c.started)"
                    ...
                    <div class="gridd" style="display: flex; gap: 1rem;">
                        ...
                        <div>
                            ...
                            <p class="text-white"> <span style="color: var(--primary-color);font-weight: bold;"> 
                                <b>Participaron</b>:</span>  {{ contest.is_site_participation? 'SEDES' : 'COLABORADORES' }} <br> </p>
...
const calcaDiferenceBetweenDates = (end) => {
    ...
    switch (answer) {
        ...
        default:
            ...
            result = `Finalizo hace   ${Math.abs(answer) } ${Math.abs(answer)>1? 'dias' : 'dia'}`
            break;
    }
