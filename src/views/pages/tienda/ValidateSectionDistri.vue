<template>
    <div class="container" style="margin-top: 7rem;display: flex;flex-direction: column;">
       ...
       Pedidos Pendidentes Distrimonster
    </p>
...
<div class="grid" style="align-items:center;justify-content: space-between;">
    <div class="col-12 md:col-6 p-3"> 
        <span  class="text-xl" style="width: 100%;"> Pedidos pendientes de validacion<span style="text-transform: capitalize;"></span> </span>
    </div>
...
<DialogoPedidoDistri></DialogoPedidoDistri>
...
import DialogoPedidoDistri from '../cocina/DialogoPedidoDistri.vue';
...
const open = (order) => {
    store.setVisible('currentOrderDistri',true)
...
const fetchTransferRequests = async () => {
    TransferRequests.value = await orderService.getOrdersValidateDistri();
