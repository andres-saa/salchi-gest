...
<P class="text-center text-4xl" style="font-weight: bold;"> Revisar permisos</P>
<div class="grid  p-3 m-0" >


    <div class="col-12 lg:col-6 grid  px-0 md:px-3 m-0  "  v-for="permiso in permisos" >


<div class="col-12 p-0 m-auto pb-4 " style="box-shadow: 0 0 10px ;height: 100%; border-radius: 1rem;max-width: 500px;overflow: hidden" >
  <!-- {{ permiso }} -->

  <div class="col-12 m-0 mb-3  " :class="permiso.tipo" style=";">
    <p class="text-2xl" style="font-weight: bold;text-transform: capitalize;">{{permiso.tipo}}</p>
  </div>
  ...
  <div class="col-12 grid m-0 p-1" >
        ...
        <div class="col-12 grid m-0 p-1">
            <p class="col-6 my-0 py-0 " style="font-weight: bold;"> <span>Estado</span></p>
            <p class="col-6 my-0 py-0 text-right ">{{permiso.status.status}}</p>
        </div>
        ...
        <div class="    p-0 mt-4" style="display: flex;gap: 0.5rem; justify-content: space-around;position: relative;bottom: 0;"> 
            <Button style="background-color: rgba(255, 255, 0, 0.35);color: rgba(0, 0, 0, 0.864); border: none;" @click="open(permiso)"> <span class=" text-sm text-center">REVISAR</span></Button>
            <Button class="" @click="openAceptar(permiso)" style="background-color: rgba(0, 255, 89, 0.35);color: rgba(0, 0, 0, 0.864); border: none;"> <span class="text-sm">APROBAR</span> </Button>
            <Button @click="openRechazar(permiso)" style="background-color: rgba(255, 0, 0, 0.35);color: rgba(0, 0, 0, 0.864); border: none;"> <span class="text-sm"> RECHAZAR</span> </Button>
        </div>
    ...
    <Dialog v-model:visible="show" :style="{ width: '700px' }" header="Revizar permiso" :modal="true"
        class="p-fluid m-2 pt-8">

       
        <div class=" a4-size p-4 lg:p-6 mi-clase mt-4" >
...
{{currentPermiso.observations }}
        ...
        <div class=" col-12 md:col-6 m-auto" style=" display: flex;gap: 1rem; border-radius: 1rem; overflow: hidden; justify-content: space-around;position: absolute;top: 0rem;right: 0; background-color:rgba(255, 255, 255, 0)te;"> 
