...
const refresh = async() => {
    items.value = await dailyInventoryReportsService.getDailyInventoryGroups()
...
const disableGroup = async(id) => {
    await dailyInventoryReportsService.disableDailyGrupInventory(id)
...
const navigateToCategory = (categoryName,category_id) => {
   ...
   router.push({ name: 'daily-inventory-settings-sesion', params: { sesion: categoryName, id:category_id } });
   
};

const saveGroup = async(data) => {
    await dailyInventoryReportsService.InsertDailyGrupInventory(data)
