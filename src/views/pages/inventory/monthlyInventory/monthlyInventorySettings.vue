<template>
    ...
    <div  style="display:flex;flex-direction:column;justify-content:center;align-items:center">
        ...
        <img v-if="routing.path == '/monthly-inventory/monthly-inventory-settings/'" style="height:60vh;object-fit:contain;width:100%;" src="/images/dailyMan.png" alt="">
...
const refresh = async() => {
    items.value = await monthlyInventoryReportsService.getMonthlyInventoryGroups()
...
const disableGroup = async(id) => {
    await monthlyInventoryReportsService.disableMonthlyGrupInventory(id)
...
const navigateToCategory = (categoryName,category_id) => {
   ...
   router.push({ name: 'monthly-inventory-settings-sesion', params: { sesion: categoryName, id:category_id } });
   
};

const saveGroup = async(data) => {
    await monthlyInventoryReportsService.InsertMonthlyGrupInventory(data)
