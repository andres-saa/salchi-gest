<template>
    ...
    <div class="mt-3" style="min-height:20vh;flex-direction: column; display: flex; justify-content:center;align-items:center">
        ...
        <DataTable style="max-width: 1024px;" v-model:filters="filters" class="col-12 m-auto"
            :value="invetnoryMonthlyReports" tableStyle="min-width: 50rem;">
            <template #header>
            ...
            <Column style="" class="py-1 px-0" field="date" header="Action">
                <template #body="data">
                    ...
                    <div style="display: flex;gap:0.5rem;">
                        ...
                        <Button
                            @click="prepareDownload(data.data.monthly_inventory_id, data.data.site_name, data.data.date)"
...
const getFiltered = async () => {
    ...
    invetnoryMonthlyReports.value = await monthlyInventoryReportsService.getAllMonthlyInventoryReportsFiltered(site_ids, new_startDate, new_endDate)
}
...
//         prepareDownload(reporte.monthly_inventory_id,reporte.site_name,reporte.date)
//     });
