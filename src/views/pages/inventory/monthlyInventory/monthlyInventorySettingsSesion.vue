...
const disableItem = async(id) => {
    await monthlyInventoryReportsService.disableMonthlyItemInventory(id)
...
const refresh = async () => {
    ...
    items.value = await monthlyInventoryReportsService.getAllMonthlyInventoryItems(group_name)
    unitMeasures.value = await monthlyInventoryReportsService.getAllMonthlyInventoryUnitMeasures()
}
...
const saveItem = async(item) => {
    const group_monthly_inventory_item_id = router.params.id
    item.monthly_inventory_item_unit_measure_id = selectedUnit.value.id
    item.group_monthly_inventory_item_id = group_monthly_inventory_item_id
    await monthlyInventoryReportsService.InsertMonthlyItemInventory(item)
