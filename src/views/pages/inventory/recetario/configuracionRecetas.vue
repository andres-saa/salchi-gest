...
<div style="max-width: 900px;" class="m-auto">
    ...
    <div style="margin-top: 3rem;">
        <DataTable :paginator="true" :rows="10" style="width: 100%;"
        paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown"
        currentPageReportTemplate="Mostrando {first} a {last} de {totalRecords} recetas"
        :rowsPerPageOptions="[5, 10,15, 25, 100]" scrollable showGridlines scrollHeight="67vh" stripedRows class="col-12 m-auto"
        ...
        <template #header>
            <div class="grid p-3" style="align-items:center;justify-content: space-between; display: flex;gap: 1rem;">
                <h4 class="p-0"> <i class="fa fa-bowl-rice"></i>  <b>Productos que tienen receta</b></h4>
        ...
        <column header="Tiene receta?" style="max-width: 4rem;" field="name" class="py-0 px-0 m-0" frozen alignFrozen="right">
 ...
 -->
                <InputSwitch @change="toggle_recipe(data.data.id, data.data.has_recipe)" v-model="data.data.has_recipe"></InputSwitch>
...
const update = async() => {
   recipes.value = await fetchService.get(`${URI}/list-recipes`,'cargando ingredientes')
