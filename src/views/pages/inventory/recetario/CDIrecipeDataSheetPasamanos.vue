        ...
        <div class="grid mx-0 md:mx-0" style="margin-top: 3rem;">
            ...
            <div class="col-12 lg:col-6 p-0 md:p-4 shadow-2 " style="border-radius: .5rem; background-color: white;">
                ...
                <div class="mx-0  p-0 " style="">
                    ...
                    <h5 style="" class=" py-2 m-0"> Nombre </h5>

                    <InputText :style="editing? 'oulined:1px solid var(--primary-color)' : ''" readOnly v-model="newIRecipe.name" placeholder="Escriba el nombre de la receta"
                        style="width: 100%;">
                    </InputText>
                ...
                <InputNumber suffix="%" :style="editing? 'oulined:1px solid var(--primary-color)' : ''" readOnly v-model="newIRecipe.iva" placeholder="Escriba el nombre de la receta" style="width: 100%;">
                </InputNumber>

                <h5 style="" class=" py-2 m-0"> Unidad de medida</h5>

                <Dropdown :options="unitMeasures" optionLabel="name" :style="editing? 'oulined:1px solid var(--primary-color)' : ''" :disabled="true" :readidOnly="!editing" v-model="recipeUnitMeasure" placeholder="Escriba el nombre de la receta" style="width: 100%;">
                </Dropdown>

                <h5 style="" class=" py-2 m-0"> Presentacion convertir a gramdos</h5>

                <InputNumber :style="editing? 'oulined:1px solid var(--primary-color)' : ''" :readOnly v-model="newIRecipe.convert_value" placeholder="Escriba el nombre de la receta" style="width: 100%;">
                </InputNumber>
            ...
            <DataTable direction="vertical" :paginator="true" :rows="15" style="width: 100%;"
                ...
                <template #header>
                    ...
                    <div
                        ...
                        <Button v-if="view_add_ingredient_button" size="small" severity="help" @click="openNewIngredient"
                            :label="recipe.recipe.pasamanos? 'Asignar pasamanos':  'Nuevo ingrediente'"></Button>
                    </div>
...
const view_add_ingredient_button = computed( () => {
    return recipe.value.recipe.pasamanos && recipe.value.ingredients.length < 1 || !recipe.value.recipe.pasamanos
...
const recipe = ref({
    "recipe_data_sheet": {
        "id": 53,
        "labour_cost": 921,
        "bache_total_cost": null,
        "quantity_bache_total_cost": null,
        "total_cost_per_kilo": null,
        "cost_whit_labour": null,
        "cost_whit_percent_gain": null,
        "purchasing_price_whit_error": null,
        "purchasing_price_whit_error_and_iva": null
    },
    "ingredients": [],
    "recipe": {
        "id": 53,
