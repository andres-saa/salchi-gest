    ...
    <div style="max-width: 500px;" class="m-auto px-3 my-8">
        ...
        <h2 class="text-center" style="margin-top: 3rem;">
            ...
            <b style="text-transform: uppercase;">
                {{ newIRecipe.name || ' Nueva Receta CDI' }}
            </b>
        </h2>
        ...
        <div class="grid mx-0 md:mx-0" style="margin-top: 3rem;">
            ...
            <div class="col-12 p-0 md:p-4">
                ...
                <div class="mx-0  p-0 " style="">
                    ...
                    <h5 style="" class=" py-3 m-0"> Nombre de la receta</h5>

                    <InputText v-model="newIRecipe.name" placeholder="Escriba el nombre de la receta"
                        style="width: 100%;">
                    </InputText>
                </div>
                ...
                <InputNumber v-model="newIRecipe.convert_value" placeholder="Para Kilogramos en 1000" style="width: 100%;"
                    ...
                    <!-- <div style="width: 100%;display: flex ;justify-content: space-between;align-items: center;">
                        <h5 style="" class=" py-0 my-3"> Es un pasamanos?</h5>
                        <inputSwitch class=" py-2 " v-model="newIRecipe.pasamanos"></inputSwitch>
                    </div>
...
const createCdiRecipeDataShee = async () => {
    ...
    if (!data.name || data.iva === null   || !data.unitMeasure?.id || !data.convert_value){
        alert (
...
console.log(newData)
    ...
    const recipe_id = await fetchService.post(`${URI}/create-cdi-recipe-data-sheet/`, newData, 'Creando receta')
