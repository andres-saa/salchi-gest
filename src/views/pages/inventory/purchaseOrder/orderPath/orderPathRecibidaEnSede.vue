<template>
    ...
    <Dialog class="mx-2" v-model:visible="showActionDialog" modal header="Interactuar con la orden"
        ...
        <div class="m-0 p-0"
            ...
            <Button @click="openPrepare(dataToInract.purchase_order_id)" label="Recibir orden" style=""
    ...
    <Dialog class="px-2" v-model:visible="showPrepare" modal header="Recibir orden"
        ...
        <div class="m-0 p-0"
            ...
            <p class="m-0 p-0"><b>Transportado por:</b> {{ dataToInract.responsible_lap }} </p>
            <p class="m-0 p-0"><b>Sede:</b> {{ dataToInract.site_name }} </p>
            <p class="mt-0 p-0"><b>Fecha</b> {{ dataToInract.status_timestamp.split('T')[0] }} </p>
            ...
            <DataTable showGridlines style="max-width: 1024px;" stripedRows v-model:filters="filters"
                ...
                <Column class="py-0 " field="quantity_adjusted" header="cant. Reportada por transportista">
                    <template #body="data">
                        <p class="text-right">
    ...
    <div class="mt-3" style="min-height:20vh; display: flex; justify-content:center;align-items:center">
        ...
        <DataTable showGridlines style="max-width: 1024px;" v-model:filters="filters" class="col-12 m-auto"
            ...
            <template #header>
                <div class="grid" style="align-items:center">
                    <div class="col-12 md:col-6 p-3">
                        <span class="text-xl" style="width: 100%;"> Ordenes pendientes por Recibir</span>
                    </div>
                    <div class="col-12 md:col-6 p-3">
            ...
            <Column class="py-1" field="responsible_lap" header="Transportada por"></Column>
            ...
            <Column class="py-1" field="date" header="Estado actual">
                ...
                <template #body="data">
                    <Tag style="width: 100%;height:2.7rem;color: black;"
...
const color_code = [
    ...
    },
    {
        ...
        description: 'El transportista reporto menos de lo que habia'
    },
    {
        color: ' rgb(255, 175, 51)',
        description: 'Recibiste menos de lo reportado por el transportista'
    }
]
...
const sendData = async (itemsData) => {
    ...
    loadingStore.setLoading(true, 'Recibiendo orden')
    const dataToSend = {
    ...
    loadingStore.setLoading(false, 'Recibiendo orden')
...
const verify = (data) => {
    if (data.ajustment > data.quantity) {
        alert('Estas seguro de que  hay mas de lo reportado por el transportista')
