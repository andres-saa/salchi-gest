<template>
    ...
    <Dialog class="mx-2" v-model:visible="showActionDialog" modal header="Interactuar con la orden" :style="{ width: '25rem' }">

        <div class="m-0 p-0" style="display: flex;width:min-content;width: 100%; flex-direction: column; justify-content:start;gap:0.5rem">
                        ...
                        <Button text label="Descargar en excel" style="" @click="prepareDownload(dataToInract.purchase_order_id,dataToInract.site_name,dataToInract.expedition_date?.split('T')[0])" severity="success" class=""
                            icon="pi pi-download" />
    ...
    <div class="mt-3" style="min-height:20vh; display: flex; justify-content:center;align-items:center">
        ...
        <DataTable style="max-width: 1024px;" v-model:filters="filters" class="col-12 m-auto"
            ...
            <Column class="py-1" field="responsible_lap" header="Recibido por"></Column>
