...
const disableItem = async(id) => {
    await cdiInventoryReportsService.disableCdiItemInventory(id)
...
const refresh = async () => {
    ...
    items.value = await cdiInventoryReportsService.getAllCdiInventoryItems(group_name)
    unitMeasures.value = await cdiInventoryReportsService.getAllCdiInventoryUnitMeasures()
}
...
const saveItem = async(item) => {
    const group_cdi_inventory_item_id = router.params.id
    item.cdi_inventory_item_unit_measure_id = selectedUnit.value.id
    item.group_cdi_inventory_item_id = group_cdi_inventory_item_id
    await cdiInventoryReportsService.InsertCdiItemInventory(item)
