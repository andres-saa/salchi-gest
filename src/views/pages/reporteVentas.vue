<template>
    ...
    <div class="col-12 px-3 md:px-4 mx-auto" style="position: relative; max-width: 1366px; margin-top: 6rem;" >
       ...
       <div class="text-sm col-12 p-2  md:col-4  xl:col-6 ">
        <MultiSelect style="" display="chip" multiple v-model="store.selectedSites" optionLabel="site_name" :options="store.sites?.filter(s => s.show_on_web)" class="text-sm col-12 p-0" placeholder="Sedes"></MultiSelect>
       </div>
