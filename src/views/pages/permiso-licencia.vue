<template>
  <div class="  mx-0 md:mx-auto " style="margin-top: 6rem;">

    <p class="text-2xl lg:text-3xl text-center my-4 mt-8 " style="font-weight: bold;">Solicitar permiso por licencia</p>
  ...
  @click="getUser(usrDni)"></Button>
    ...
    <div v-if="user.dni && usrDni" class=" col-12  p-0 m-auto"
      ...
      <div style="display: flex;">
        <Button @click="solicitarPermiso()" :disable="store.Loading.visible"
    ...
    <div class=" col-12 p-0 mt-6" style=";overflow-x: auto;  box-shadow: 0 0 20px rgba(0, 0, 0, 0.308)"
      ...
      <div class=" a4-size p-8 mi-clase" style="box-shadow: 0 0 10px rgba(0, 0, 0, 0.508)">
        ...
        <h6 class="text-center py-4" style="font-weight: bold;">FORMATO SOLICITUD DE LICENCIA <span
...
<p class="py-0  my-0">
  NIT. 901420874-0
    ...
    <div v-if="!user.dni" class="col-12">
      <img src="/images/licencia.avif" alt="" srcset="" style="width: 100%;height: 50vh;object-fit: cover; border-radius: 1rem;">
    </div>
