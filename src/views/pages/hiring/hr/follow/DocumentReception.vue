<template>
    ...
    <div class="m-auto" style="width: 100%; max-width: 900px;">
        <div>
            <h3 class="text-center py-5" style="width: 100%;"> <b>Lista de verificacion de documentos de ingreso</b>
            </h3>
        </div>



        <div class="grid gap-0 m-0 p-0">

            <div class="col-6 p-2" style="outline: 1px solid;">
                <h4 class="m-0">Fecha de ingreso</h4>
            </div>

            <div class="col-6 p-2" style="outline: 1px solid;">
                <h4 class="m-0">23-oct-2024</h4>
            </div>


            <div class="col-6 p-2" style="outline: 1px solid;">
                <h4 class="m-0">Nombre del empleado</h4>
            </div>

            <div class="col-6 p-2" style="outline: 1px solid;">
                <h4 class="m-0">Ana Gómez
                </h4>
            </div>


            <div class="col-3 p-2" style="outline: 1px solid;">
                <h4 class="m-0">Tipo de documento</h4>
            </div>

            <div class="col-1 p-2" style="outline: 1px solid;">
                <h4 class="m-0">C.C</h4>
            </div>

            <div class="col-4 p-2" style="outline: 1px solid;">
                <h4 class="m-0">Numero de documento</h4>
            </div>

            <div class="col-4 p-2" style="outline: 1px solid;">
                <h4 class="m-0">1003153254</h4>
            </div>
        ...
        <div class="grid m-0 p-0">
            ...
            <div class="col-9 p-2" style="outline: 1px solid;background-color: var(--primary-color);">
                <h4 class="m-0" style="color: white;font-weight: bold;">Documentos de trabajador</h4>
            </div>

            <div class="col-1 p-2" style="outline: 1px solid;background-color: var(--primary-color);">
                <h4 style="color: white;font-weight: bold;" class="m-0" >Si</h4>
            </div>

            <div class="col-1 p-2" style="outline: 1px solid;background-color: var(--primary-color);">
                <h4 style="color: white;font-weight: bold;" class="m-0">No</h4>
            </div>

            <div class="col-1 p-2" style="outline: 1px solid;background-color: var(--primary-color);">
                <h4 style="color: white;font-weight: bold;" class="m-0">N/A</h4>
            </div>
            ...
            <div v-for="i in documentos" class="grid col-12 m-0 p-0">
                <div class="col-9 p-2" style="outline: 1px solid;">
                    <h4 class="m-0">{{ i }}</h4>
                    <Tag>cargar</Tag>
                </div>
                
                <div class="col-1 p-2" style="outline: 1px solid;display: flex;align-items: center;justify-content: center;">
                    <Checkbox style="width: "></Checkbox>
                </div>
        ...
        <div style="display: flex;justify-content: end; width: 100%;">
            ...
            <Button class="my-4" label="Contratar" severity="help"></Button>
...
const documentos = [
    "Fotocopia de la cédula ampliadas al 150%",
    "Hoja de vida",
    "Certificados académicos",
    "Referencias Laborales",
    "Certificado de antecedentes",
    "Antecedentes penales y requerimientos judiciales",
    "Certificación cuenta bancaria de nómina",
    "Otros solicitados"
];
