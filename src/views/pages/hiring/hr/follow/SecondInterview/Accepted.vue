    ...
    <DataTable :paginator="true" :rows="5" style="width: 100%;max-width: 1280px;"
         ...
         <template #body="data" >
            ...
            <div style="display: flex;flex-direction: column; gap:.1rem">
                 ...
                 <Button  style="min-width: max-content" size="small" @click="chargeHistory(data.data.lap_history)" label="Iniciar contratacion" severity="success" icon="pi pi-check p-0" class="my-0 py-1"></Button>
