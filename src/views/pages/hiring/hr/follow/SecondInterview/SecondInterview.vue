<template>
 ...
 <div style="max-width: 1280px;margin: auto;">
    ...
    <div  class="py-4">
                    <h4 class="px-2"> <i class="fa-regular fa-bars-progress"></i>  <b>Filtro 2 Entrevista con el lider que solicito la requisición</b></h4>
...
<nav  class="nav-bar shadow-1 m-0 p-0">
    <ul>
        <li class="nav-bar--item" v-for="(button, index) in navItems" :key="index" style="display: flex;">
            <router-link :to="`/hiring-hr-follow/second-interview/${button.path}/132`">
