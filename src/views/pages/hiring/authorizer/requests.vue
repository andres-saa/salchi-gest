    ...
    <DataTable :paginator="true" :rows="15" style="width: 100%;max-width: 1280px;"
         ...
         <template #header>
             <div class="grid p-3" style="align-items:center;justify-content: space-between; display: flex;gap: 1rem;">
                 <h4 class="px-2"> <i class="fa-regular fa-bars-progress"></i>  <b>Solicitudes de requisición para aprobar</b></h4>
         ...
         <Column class="my-0 py-0 px-0 mx-0" style="" header="Interactuar" >
          <template #body="data" >
             ...
             <div style="display: flex;gap: .5rem;justify-content: center;" class="px-2">
                  <!-- <Button @click="chargeHistory(data.data.lap_history)"  severity="warning" icon="pi pi-history p-0" class="my-2 p-1"></Button> -->
                  <Button @click="chargeRequest(data.data)"  severity="success" icon="pi pi-check p-0" class="my-1 p-1"></Button>
 ...
 const requisitions = [
  {
    ...
    "area_id": 13,
    "requester_id": 1082,
    "requisition_lap_id": 13,
    "creator_id": 1082,
    "creator_name": "ANDRES FELIPE ARECHEA",
    "created_at": "2024-10-21T22:44:19",
    "area_name": "Marketing",
    "validation_type_id": 1,
    "lap_name": "Rechazado por Gerencia General",
    "created_at_formated": "21-10-2024  10:44 PM",
    "requisition_description": "Solicitamos la aprobación de la gerencia para proceder con la contratación de un líder contable que se encargará de supervisar y optimizar las operaciones financieras durante el horario nocturno de nuestro autoservicio. Esta posición es crucial para mejorar la precisión en el manejo de las transacciones nocturnas y asegurar el cumplimiento de las normativas fiscales y empresariales. Adjuntamos el perfil del candidato ideal, la estructura de costos y el análisis de impacto esperado para su revisión y aprobación.",
    "lap_history": [
      {
        "time": "22-10-2024  01:58 PM",
        "lap": "Aprobado por Gerencia",
        "responsible": "BRYAN BONILLA LUNA",
        "comment": "La gerencia reconoce la necesidad pero requiere una revisión más detallada del ROI estimado."
      },
      {
        "time": "22-10-2024  02:05 PM",
        "lap": "Rechazado por Gerencia General",
        "responsible": "BRYAN BONILLA LUNA",
        "comment": "Después de la revisión, la gerencia general decide no aprobar el aumento debido a restricciones presupuestarias actuales."
      }
    ],
    "creator_position": "Analista de Marketing"
  },
  {
    "id": 17,
    "area_id": 3,
    ...
    "creator_id": 1132,
    "creator_name": "BRYAN BONILLA LUNA",
    "created_at": "2024-10-22T12:50:25",
    "area_name": "Producción",
    "validation_type_id": 2,
    "lap_name": "Entregado a Gestión Humana",
    "created_at_formated": "22-10-2024  12:50 PM",
    "requisition_description": "Reemplazo urgente necesario debido a la próxima licencia de maternidad de Ana Ruiz, nuestro supervisor de línea. Se requiere cubrir su posición para mantener la eficiencia operativa.",
    "lap_history": [
      {
        "time": "22-10-2024  12:50 PM",
        "lap": "Entregado a Gestión Humana",
        "responsible": "BRYAN BONILLA LUNA",
        "comment": "La solicitud se ha priorizado dada la importancia crítica del rol de Ana en la producción."
      }
    ],
    "creator_position": "Gerente General"
  },
  {
    "id": 18,
    "area_id": 5,
