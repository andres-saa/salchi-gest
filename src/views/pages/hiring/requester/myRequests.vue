   ...
   <DataTable :paginator="true" :rows="15" style="width: 100%;max-width: 1280px;"
        ...
        <template #header>
            <div class="grid p-3" style="align-items:center;justify-content: space-between; display: flex;gap: 1rem;">
                <h4 class="px-2"> <i class="fa-regular fa-bars-progress"></i>  <b>Mis solicitudes de requisicion</b></h4>
        ...
        <Column class="" style="display: flex; justify-content: center;" header="Ver historial" >
         <template #body="data" >

            <div>
                 <Button @click="chargeHistory(data.data.lap_history)"  severity="help" icon="pi pi-history p-0" class="my-2 p-1"></Button>
            </div>
         </template>
...
const tags = [
    ...
    { id: 4, name: "Aprobado por Gerente General", color: "#FFFFFF", backgroundColor: "#27AE60" }, // Verde oscuro
...
const requisitions = [
  {
    ...
    "creator_id": 3001,
    "creator_name": "ANDRES FELIPE ARRECHEA SAA",
    ...
    "lap_history": [
      {
        ...
        "lap": "Entregado a Recursos Humanos",
        "responsible": "ANDRES FELIPE ARRECHEA SAA",
    ...
    "lap_history": [
      {
        ...
        "lap": "ANDRES FELIPE ARRECHEA SAA",
