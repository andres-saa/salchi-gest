<template>
    <div class="p-3" style="min-width: 100%; margin: auto;">
        ...
        <h2 class="my-6"><b>Ventas por canal</b></h2>
        ...
        <Chart :type="type_graph.reporte_basico.value" :data="store.OrderDataGraphics.reporte_basico" class="h-[10rem] p-2 h-50"
            style="width: 100%; box-shadow: 0 0 10px rgba(0, 0, 0, .2); border-radius: .5rem;" />


        
            <h2 class="my-6"><b>Ventas Totales periodo actual vs periodo anterior</b></h2>




            <Chart type="line":data="store.OrderDataGraphics.total" class="h-[10rem] p-2 h-50"
            style="width: 100%; box-shadow: 0 0 10px rgba(0, 0, 0, .2); border-radius: .5rem;" />



            <h2 class="my-6"><b>Ventas Call center periodo actual vs periodo anterior</b></h2>
        ...
        <Chart type="line" :data="store.OrderDataGraphics.callcenter" class="h-[10rem] p-2 h-50"
            style="width: 100%; box-shadow: 0 0 10px rgba(0, 0, 0, .2); border-radius: .5rem;" />
        ...
        <h2 class="my-6"><b>Ventas Salchibot periodo actual vs periodo anterior</b></h2>

        <Chart type="line" :data="store.OrderDataGraphics.chatbot" class="h-[10rem] p-2 h-50"
            style="width: 100%; box-shadow: 0 0 10px rgba(0, 0, 0, .2); border-radius: .5rem;" />
        ...
        <h2 class="my-6"><b>Ventas Pagina web periodo actual vs periodo anterior</b></h2>

        <Chart type="line" :data="store.OrderDataGraphics.web" class="h-[10rem] p-2 h-50"
            style="width: 100%; box-shadow: 0 0 10px rgba(0, 0, 0, .2); border-radius: .5rem;" />
    </div>
</template>
...
// const store.OrderDataGraphics = ref([])

watch(() => store.dateRange, async () => {

    const site_ids = store.selectedSites.map(s => s.site_id)
    store.OrderDataGraphics = await fetchService.post(`${URI}/get_daily_sales_report/`, {
