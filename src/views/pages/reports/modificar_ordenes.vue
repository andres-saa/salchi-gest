<template>
  <div class="grid xl:mx-0 mx-0  py-0 my-6 px-0" style="background-color: white;width: 100%;">
      ...
      <nav >
        ...
        <ul class="pb-0 p-0" style="display: flex;flex-wrap: wrap; gap:1rem;list-style: none;overflow-x: auto;">
          ...
          <li style="display: flex; gap:1rem;">
           ...
           <InputText style="" v-model.trim="searchId"  placeholder="Buscar por id (sin #)"></InputText>   
