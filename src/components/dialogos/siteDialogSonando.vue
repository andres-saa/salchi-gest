<template>
    <Dialog class="dialog-content" style="background-color: #000000ba !important ;   ; color: white;max-width: 94%; padding: 0;"
        ...
        <template #footer>
            <div class="button-container">
                <Button label="Aplicar" severity="help" @click="applySelection" :disabled="!selectedSite" class="apply-" />
            </div>
        </template>
    </Dialog>
</template>
