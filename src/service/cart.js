...
function contarObjetosRepetidos(arr) {
    ...
    // Contar la cantidad de veces que se repite cada objeto por su nombre "producto", adiciones y salsas
    arr.forEach((objeto) => {
        ...
        const clave = `${nombre}-${adiciones}-${salsas}`; // Incluir salsas en la clave
    ...
    // Retornar el array de resultados directamente
