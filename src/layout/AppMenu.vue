  ...
  model.value = [
    {
      ...
      'icon-color': 'red',
      color: 'red',
      permision_id: get_id([65]),
      items: [
        {
          label: 'codigos redimidos',
      ...
      items: [
        {
          ...
          items: [
            ...
            {
              label: 'Métodos de pago call center',
              icon: 'fa-solid fa-phone',
              to: '/payment-methods-call-center/',
              permision_id: 1,
              'icon-color': '#FFCC80',
              color: '#FFCC80',
            },
            ...
            },
            {
              ...
              to: '/tienda-menu/productos/SALCHIPAPAS/3',
              permision_id: 2,
              'icon-color': '#A5D6A7',
              color: '#A5D6A7',
            },
            ...
            },
            {
              ...
              to: '/cancellation-requests/revisar/',
              permision_id: 7,
              'icon-color': '#FF7043',
              color: '#FF7043',
            },
      ...
      items: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              to: '/recetario/recipe-sumary-benefit/',
              permision_id: 14,
              'icon-color': '#00C853',
              color: '#00C853',
            },
        ...
        },
        {
          ...
          items: [
            {
              label: 'Reportar inventario diario',
              icon: 'fa-solid fa-edit',
              to: '/daily-inventory/report-inventory',
              permision_id: 11,
              'icon-color': '#1E88E5',
              color: '#1E88E5',
            },
            {
              ...
              to: '/daily-inventory/daily-inventory-reports',
              permision_id: 10,
              'icon-color': '#43A047',
              color: '#43A047',
            },
        ...
        },
        {
          ...
          items: [
            {
              label: 'Reportar inventario mensual',
              icon: 'fa-solid fa-file-circle-plus',
              to: '/monthly-inventory/report-monthly-inventory',
              permision_id: 17,
              'icon-color': '#FFD54F',
              color: '#FFD54F',
            },
            {
              label: 'Revisar reportes',
              icon: 'fa-solid fa-eye',
              to: '/monthly-inventory/monthly-inventory-reports',
              permision_id: 18,
              'icon-color': '#9CCC65',
              color: '#9CCC65',
            },
          ...
          items: [
            {
              label: 'Nueva',
              icon: 'fa-solid fa-file-circle-plus',
              to: '/purchase-order/generate-purchase-order',
              permision_id: 21,
              'icon-color': '#FF7043',
              color: '#FF7043',
            },
            {
              label: 'Generadas por mí',
              icon: 'fa-solid fa-folder-open',
              to: '/purchase-order/purchase-order-my-orders/',
              permision_id: 21,
              'icon-color': '#42A5F5',
              color: '#42A5F5',
            },
            {
              ...
              to: '/purchase-order/recorrido/alistar/',
              permision_id: 22,
              'icon-color': '#66BB6A',
              color: '#66BB6A',
            },
            {
              label: 'Autorizar',
              icon: 'fa-solid fa-check-double',
              to: '/purchase-order/recorrido/autorizar',
              permision_id: 23,
              'icon-color': '#AB47BC',
              color: '#AB47BC',
            },
            {
              label: 'Transportar',
              icon: 'fa-solid fa-truck',
              to: '/purchase-order/recorrido/transport/',
              permision_id: 24,
              'icon-color': '#FB8C00',
              color: '#FB8C00',
            },
            {
              label: 'Recibir en la sede',
              icon: 'fa-solid fa-building-circle-check',
              to: '/purchase-order/recorrido/recibida-en-sede/',
              permision_id: 25,
              'icon-color': '#00ACC1',
              color: '#00ACC1',
            },
            {
              ...
              to: '/purchase-order/recorrido/completed/',
              permision_id: 25,
              'icon-color': '#43A047',
              color: '#43A047',
            },
            {
              ...
              to: '/purchase-order/recorrido/purchase-order-reports/',
              permision_id: 26,
              'icon-color': '#8E24AA',
              color: '#8E24AA',
            },
            {
              label: 'Stock',
              icon: 'fa-solid fa-boxes-stacked',
              to: '/purchase-order/recorrido/purchase-order-settings/',
              permision_id: 27,
              'icon-color': '#5C6BC0',
              color: '#5C6BC0',
            },
...

    {
      ...
      items: [
        {
          label: 'Base de datos del personal',
        ...
        },
        {
          ...
          to: '/contracts/contracts-to-finish',
          permision_id: 29,
          'icon-color': '#FF7043',
          color: '#FF7043',
        },
...

    {
      ...
      items: [
        {
          label: 'Administrar PQRS',
          icon: 'fa-solid fa-folder-tree',
          to: '/pqrs/pagina_web/1',
          permision_id: 55,
          'icon-color': '#FF7043',
          color: '#FF7043',
        },
...

    {
      ...
      items: [
        {
          label: 'Generar certificado laboral',
...

    {
      ...
      items: [
        ...
        },
        {
          label: 'Mi formación',
          icon: 'fa-solid fa-chalkboard-user',
          to: '/video-training-sequences/',
          permision_id: 45,
          'icon-color': '#FFD54F',
          color: '#FFD54F',
        },
        {
          label: 'Administrar escuelas',
          icon: 'fa-solid fa-school',
          to: '/video-training-video-sesion',
          permision_id: 46,
          'icon-color': '#FB8C00',
          color: '#FB8C00',
        },
